...
public class EncryptWithKeyStore {
    ...
    public static void main (String[] args) {
      ...
      File keyStoreFile = new File("MiContenedorDeLLaves.jks");
	...
	Certificate cert = myKeyStore.getCertificate("miprimerpardellaves");
	PublicKey publicKey = cert.getPublicKey();
	@SuppressWarnings("unused")
	  PrivateKey privatekey = (PrivateKey) myKeyStore.getKey("miprimerpardellaves", "llave123".toCharArray()); 
